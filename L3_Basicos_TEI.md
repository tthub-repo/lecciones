...
En los casos, por ejemplo, que quisiéramos dividir ulteriormente un párrafo, podríamos utilizar otros elementos como `<s>` (segment) para dividir otro tipo de segmentos, como por ejemplo, las frases:
